...
namespace обучалка
{
    ...
    static class met    //класс-набор методов
    {
            ...
            if (hei > 0 && fuel == 0)     // проверка топлива на высоте больше нуля
            {
                ...
                switch (command)
                {
                    ...
                    case 2:
                        ...
                        if (hei > 0)  // ситуация откл. двигателя на высоте больше нуля
                        {
                        ...
                        break;
                    case 3:
                        if (hei == 0 && speed == 0)    // заправка возможна только при высоте и ск-ти = 0
                        {
                            plane.getfuel();
                        }
                        else
        ...
        // хотя конечно, лол, не все возможные ситуации учтены, но ладно )) 
    }
